        # Truthcert Denominator: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/truthcert-denominator.git

        ## Objective

        TruthCert Denominator implements denominator-calibrated living network meta-analysis with TruthCert proof-carrying certificates, ensuring auditable and reproducible evidence synthesis, targeting PLOS ONE.
        ...
        - Code: https://github.com/mahmood726-cyber/truthcert-denominator.git
